...
class Config(object):
    ...
    def __init__(self):
        ...
        self.save_path = root_dir + 'Dataset/' + self.dataset + '/' + self.dataset + '.result' + '.ckpt'
        ...
        self.doc_doc_Dis_dir = root_dir + 'Dataset/' + self.dataset + '/' + self.dataset + '_doc_to_doc_Dis_Graph_' + str(self.each_doc_out_degree_dis) + '.dgl'
        self.doc_doc_Pmi_dir = root_dir + 'Dataset/' + self.dataset + '/' + self.dataset + '_doc_to_doc_PMI_Graph_' + str(self.each_doc_out_degree_pmi) + '.dgl'
        self.doc_doc_Topic_dir = root_dir + 'Dataset/' + self.dataset + '/' + self.dataset + '_doc_to_doc_LDA_Graph_' + str(self.each_doc_out_degree_top) + '.dgl'
