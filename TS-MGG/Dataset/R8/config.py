...
class Config(object):
    ...
    def __init__(self):
        ...
        self.word_word_Dis_dir = root_dir + 'Dataset/' + self.dataset + '/' + self.dataset + '_word_to_word_Dis_Graph_' + str(
            self.each_word_out_degree_dis) + '.dgl'
        self.word_word_Pmi_dir = root_dir + 'Dataset/' + self.dataset + '/' + self.dataset + '_word_to_word_PMI_Graph_' + str(
            self.each_word_out_degree_pmi) + '.dgl'
        self.word_word_Topic_dir = root_dir + 'Dataset/' + self.dataset + '/' + self.dataset + '_word_to_word_LDA_Graph_' + str(
            self.each_word_out_degree_top) + '.dgl'
